...
export default class GuessManager2
{
    constructor(scene, config)
    {
        ...
        this.text = this.scene.add.text(0, -200,
            ["Again, one of them is me, the other is an AI.","Guess which one is me.","Answer in "+Math.max(Math.floor(this.answerTimer))],
    ...
    update(dt)
    {
        ...
        {
            this.text.setText(["Again, one of them is me, the other is an AI.","Guess which one is me.","Answer in "+Math.max(Math.floor(this.answerTimer))+' sec']);
        }
        else
        {
            this.text.setText(["I am the green one"]);
            for(let i of this.warriors)
            {
                if(!i.brain)
                {
